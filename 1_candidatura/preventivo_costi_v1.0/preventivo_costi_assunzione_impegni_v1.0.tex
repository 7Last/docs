...
\begin{itemize}
    \item \textbf{6 settimane per lo sviluppo del \textit{PoC (Proof of Concept)}:} in questa fase cercheremo le tecnologie che, insieme a quelle proposte dall'azienda, possono essere utili per sviluppare quanto richiesto dal capitolato scelto. Una volta individuate, le studieremo per utilizzarle al meglio.
