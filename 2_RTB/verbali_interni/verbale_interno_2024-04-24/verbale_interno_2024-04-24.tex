...
\begin{itemize}
	...
	\item Revisione pianificazione scadenze
...
\begin{itemize}
	...
	Abbiamo iniziato lo studio e l'analisi dei prossimi strumenti da utilizzare, ovvero \textbf{ClickHouse} e \textbf{Grafana}. Al fine di migliorare la persistenza dati su \textbf{ClickHouse} e integrare \textbf{Grafana} %bozza: sicuramente da rivedere
\end{itemize}
...
\subsection{Mail per conferma Redpanda}
...
...
Concludiamo la riunione impegnandoci a completare le attività rimanenti entro il termine del secondo sprint e ci diamo appuntamento per il prossimo incontro interno previsto per il 2024/05/01
