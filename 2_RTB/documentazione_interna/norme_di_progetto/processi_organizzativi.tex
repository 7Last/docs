...
\begin{table}[!h]
	...
	\begin{tabular}{ | c | l | }
		...
		\hline
		\underline{\hyperlink{29M}{29M-FU}}  & Facilità di utilizzo            \\
        \underline{\hyperlink{30M}{30M-TA}}  & Tempo di apprendimento          \\
        \underline{\hyperlink{31M}{31M-TR}}  & Tempo di risposta               \\
        \underline{\hyperlink{32M}{32M-TE}}  & Tempo di elaborazione           \\
        \underline{\hyperlink{33M}{33M-QMS}} & Metriche di qualità soddisfatte \\
		\hline
	\end{tabular}
