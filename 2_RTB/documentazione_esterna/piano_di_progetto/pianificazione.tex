...
\begin{table}[!h]
    ...
    \begin{tabular}{ | l | c | c | c | c | c | c | c | }
        ...
        \hline
    \end{tabular}
    \caption{Consuntivo orario per ruolo dei membri del team durante il quarto sprint} % TODO mettere numero sprint corretto
    \label{tab:26} % TODO mettere numero di tabella corretto
\end{table}
...
\begin{table}[!h]
    ...
    \begin{tabular}{ | l | c | c | c | c | c | }
        ...
        \hline
    \end{tabular}
    \caption{Consuntivo economico consuntivo durante il quarto sprint} % TODO mettere numero sprint corretto
    \label{tab:27} % TODO mettere numero di tabella corretto
\end{table}
...
\begin{table}[!h]
    ...
    \begin{tabular}{ | p{6cm} | p{2.5cm} | p{7.5cm} | }
        ...
        \hline
    \end{tabular}
    \caption{Rischi effettivamente occorsi e loro mitigazione durante il quarto sprint} % TODO mettere numero sprint corretto
    \label{tab:28} % TODO mettere numero di tabella corretto
\end{table}
...
%         \hline
%     \end{tabular}
%     \caption{Preventivo orario per ruolo dei membri del team durante il quarto sprint} % TODO mettere numero di sprint corretto
...
%         \end{axis}
%     \end{tikzpicture}
%     \caption{Impegno preventivo per ruolo dei membri del team durante il quarto sprint} % TODO mettere numero sprint corretto
...
%         }
%         \end{tikzpicture}
%     \caption{Ripartizione in percentuale dei ruoli nel quarto sprint} % TODO mettere numero sprint corretto
