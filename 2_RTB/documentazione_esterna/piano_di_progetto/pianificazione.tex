...
\newpage
 ...
 \subsubsubsection{Retrospettiva}
In questo sprint il gruppo si è concentrato sulla preparazione della documentazione necessaria per la revisione
di avanzamento.
...
Il gruppo in questo sprint si concentrerà sulla preparazione della presentazione per la revisione di avanzamento con il
professor Vardanega, in attesa della valutazione sulla presentazione svolta con il professor Cardin.
Inoltre sarà continuata la documentazione del progetto, in particolare:
\begin{itemize}
...
\begin{figure}[!h]
	...
	\begin{tikzpicture}
		...
		#1
		\fi}
		\pie[pos={8,0},radius=3.5,text=legend,before number=\printonlypositive,color={resp,amm,an,pj,pg,ver}] {
...
%         \hline
%     \end{tabular}
%     \caption{Consuntivo economico consuntivo durante il sesto \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#sprint}{sprint\textsubscript{G}}} % TODO mettere numero \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#sprint}{sprint\textsubscript{G}} corretto
...
%         \hline
%     \end{tabular}
%     \caption{Rischi effettivamente occorsi e loro mitigazione durante il sesto \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#sprint}{sprint\textsubscript{G}}} % TODO mettere numero \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#sprint}{sprint\textsubscript{G}} corretto
% \end{table}
%
% \subsubsubsection{Retrospettiva}
