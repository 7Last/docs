...
\subsubsubsection{UC-1.5: Visualizzazione tabella dati grezzi temperatura}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\begin{center}
	...
	\captionof{figure}{UC-1.5: Visualizzazione tabella dati grezzi temperatura}
\end{center}

\subsubsubsection{UC-1.6: Visualizzazione tabella dati grezzi umidità}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\begin{center}
	...
	\captionof{figure}{UC-1.6: Visualizzazione tabella dati grezzi umidità}
\end{center}

\subsubsubsection{UC-1.7: Visualizzazione tabella dati grezzi traffico}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.7.png}
	\captionof{figure}{UC-1.7: Visualizzazione tabella dati grezzi traffico}
\end{center}

\subsubsubsection{UC-1.8: Visualizzazione tabella dati grezzi qualità dell'aria}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.8.png}
	\captionof{figure}{UC-1.8: Visualizzazione tabella dati grezzi qualità dell'aria}
\end{center}

\subsubsubsection{UC-1.9: Visualizzazione tabella dati grezzi precipitazioni}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.9.png}
	\captionof{figure}{UC-1.9: Visualizzazione tabella dati grezzi precipitazioni}
\end{center}

\subsubsubsection{UC-1.10: Visualizzazione tabella dati grezzi isole ecologiche}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.10.png}
	\captionof{figure}{UC-1.10: Visualizzazione tabella dati grezzi isole ecologiche}
\end{center}

\subsubsubsection{UC-1.11: Visualizzazione tabella dati grezzi livello di acqua}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.11.png}
	\captionof{figure}{UC-1.11: Visualizzazione tabella dati grezzi livello di acqua}
\end{center}

\subsubsubsection{UC-1.12: Visualizzazione tabella dati grezzi colonnine di ricarica}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.12.png}
	\captionof{figure}{UC-1.12: Visualizzazione tabella dati grezzi colonnine di ricarica}
\end{center}

\subsubsubsection{UC-1.13: Visualizzazione grafico time series dati grezzi complessivi temperatura}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.13.png}
	\captionof{figure}{UC-1.6: Visualizzazione grafico time series dati grezzi complessivi temperatura}
\end{center}

\subsubsubsection{UC-1.14: Visualizzazione grafico time series dati grezzi complessivi umidità}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
	\item \textbf{Postcondizioni}: L'autorità locale visualizza un grafico time series contenente i dati grezzi trasmessi da tutti i sensori
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.14.png}
	\captionof{figure}{UC-1.14: Visualizzazione grafico time series dati grezzi complessivi umidità}
\end{center}

\subsubsubsection{UC-1.15: Visualizzazione grafico time series dati grezzi complessivi traffico}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
	\item \textbf{Postcondizioni}: L'autorità locale visualizza un grafico time series contenente i dati grezzi trasmessi da tutti i sensori
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.15.png}
	\captionof{figure}{UC-1.15: Visualizzazione grafico time series dati grezzi complessivi traffico}
\end{center}

\subsubsubsection{UC-1.16: Visualizzazione grafico time series dati grezzi complessivi qualità dell'aria}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
	\item \textbf{Postcondizioni}: L'autorità locale visualizza un grafico time series contenente i dati grezzi trasmessi da tutti i sensori
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.16.png}
	\captionof{figure}{UC-1.16: Visualizzazione grafico time series dati grezzi complessivi qualità dell'aria}
\end{center}

\subsubsubsection{UC-1.17: Visualizzazione grafico time series dati grezzi complessivi precipitazioni}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
	\item \textbf{Postcondizioni}: L'autorità locale visualizza un grafico time series contenente i dati grezzi trasmessi da tutti i sensori
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.17.png}
	\captionof{figure}{UC-1.17: Visualizzazione grafico time series dati grezzi complessivi precipitazioni}
\end{center}

\subsubsubsection{UC-1.18: Visualizzazione grafico time series dati grezzi complessivi isole ecologiche}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
	\item \textbf{Postcondizioni}: L'autorità locale visualizza un grafico time series contenente i dati grezzi trasmessi da tutti i sensori
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.18.png}
	\captionof{figure}{UC-1.18: Visualizzazione grafico time series dati grezzi complessivi isole ecologiche}
\end{center}

\subsubsubsection{UC-1.19: Visualizzazione grafico time series dati grezzi complessivi livello di acqua}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
	\item \textbf{Postcondizioni}: L'autorità locale visualizza un grafico time series contenente i dati grezzi trasmessi da tutti i sensori
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.19.png}
	\captionof{figure}{UC-1.19: Visualizzazione grafico time series dati grezzi complessivi livello di acqua}
\end{center}

\subsubsubsection{UC-1.20: Visualizzazione grafico time series dati grezzi complessivi colonnine di ricarica}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: L'autorità locale ha effettuato l'accesso al sistema ed esso è in funzione;
	\item \textbf{Postcondizioni}: L'autorità locale visualizza un grafico time series contenente i dati grezzi trasmessi da tutti i sensori
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-1.20.png}
	\captionof{figure}{UC-1.20: Visualizzazione grafico time series dati grezzi complessivi colonnine di ricarica}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-5.5.png}
	\captionof{figure}{UC-5.5: Visualizzazione \textit{panel} giorno con precipitazioni maggiori nel periodo di tempo selezionato}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-5.6.png}
	\captionof{figure}{UC-5.6: Visualizzazione \textit{panel} giorno con precipitazioni minori nel periodo di tempo selezionato}
\end{center}
...
\subsubsubsection{UC-9.1: Visualizzazione \textit{panel} con riempimento isole ecologiche in tempo reale}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\begin{center}
	...
	\captionof{figure}{UC-9.1: Visualizzazione \textit{panel} riempimento isole ecologiche in tempo reale}
\end{center}

\subsubsubsection{UC-9.2: Visualizzazione mappa interattiva isole ecologiche}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\begin{center}
	...
	\captionof{figure}{UC-9.2: Visualizzazione mappa interattiva sensori isole ecologiche}
\end{center}

\subsubsubsection{UC-9.3: Visualizzazione grafico time series isole ecologiche}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-9.3.png}
	\captionof{figure}{UC-9.3: Visualizzazione grafico time series isole ecologiche}
\end{center}

\subsubsubsection{UC-9.4: Visualizzazione panel ore di saturazione isole ecologiche}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-9.4.png}
	\captionof{figure}{UC-9.4: Visualizzazione panel ore di saturazione isole ecologiche}
\end{center}

\subsubsubsection{UC-9.5: Visualizzazione \textit{panel} con percentuale media di riempimento al momento dello svuotamento}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-9.5.png}
	\captionof{figure}{UC-9.5: Visualizzazione panel percentuale media di riempimento al momento dello svuotamento}
\end{center}

\subsubsubsection{UC-9.6: Visualizzazione \textit{panel} con percentuale tempo trascorso per livello di riempimento}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-9.6.png}
	\captionof{figure}{UC-9.6: Visualizzazione \textit{panel} percentuale tempo trascorso per livello di riempimento}
\end{center}
...
\subsubsection{UC-21: Applicazione filtri}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
	...
	\item \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#user-story}{\textbf{User story}\textsubscript{G}}:
	      ...
	      I filtri che desidero applicare sono il nome del sensore, il tipo del sensore e la data di rilevamento delle misurazioni.
\end{itemize}
\begin{center}
...
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-21.png}
	\captionof{figure}{UC-21: Applicazione filtro}
\end{center}

\subsubsection{UC-21.1: Applicazione filtro per tipo di sensore}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-21.1.png}
	\captionof{figure}{UC-21.1: Applicazione filtro per tipo di sensore}
\end{center}

\subsubsection{UC-21.2: Applicazione filtro per nome del sensore}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-21.2.png}
	\captionof{figure}{UC-21.2: Applicazione filtro per nome del sensore}
\end{center}

\subsubsection{UC-21.3: Applicazione filtro temporale}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-21.3.png}
	\captionof{figure}{UC-21.3: Applicazione filtro temporale}
\end{center}

\subsubsection{UC-22: Ricezione notifiche superamento soglie}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-22.png}
	\captionof{figure}{UC-22: Visualizzazione notifiche superamento soglie}
\end{center}

\subsubsection{UC-22.1: Ricezione notifiche superamento soglia di temperatura}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: Nessuna
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-22.1.png}
	\captionof{figure}{UC-22.1: Ricezione notifiche superamento soglie di temperatura}
\end{center}

\subsubsection{UC-22.2: Ricezione notifiche superamento soglia di riempimento dell'isola ecologica}
\begin{itemize}
	\item \textbf{Attore principale}: Autorità locale;
	\item \textbf{Precondizioni}: Nessuna
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-22.2.png}
	\captionof{figure}{UC-22.2: Ricezione notifiche superamento soglia di riempimento dell'isola ecologica}
\end{center}
