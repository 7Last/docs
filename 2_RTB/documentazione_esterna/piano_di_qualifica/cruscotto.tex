...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        ...
        \begin{axis}[
            ...
            \addplot[color=amm, style={dashed, line width=3pt}, mark=none] coordinates {(Sprint 1, 1090) (Sprint 2, 2220) (Sprint 3, 2925) (Sprint 4, 3575)}; % TODO mettere valori corretti PV
...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=amm, style={dashed, line width=3pt}, mark=none] coordinates {(Sprint 1, 11695) (Sprint 2, 10670) (Sprint 3, 9670) (Sprint 4, 9050)};
...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=blue, style={line width=1pt}, mark=none] coordinates {(Sprint 1, 4) (Sprint 2, 1) (Sprint 3, -3) (Sprint 4, 0)};
            \addplot[color=yellow, style={line width=1pt}, mark=none] coordinates {(Sprint 1, 9) (Sprint 2, 7) (Sprint 3, -8) (Sprint 4, 1)};
...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=blue, style={line width=1pt}, mark=none] coordinates {(Sprint 1, 0) (Sprint 2, 80) (Sprint 3, 90) (Sprint 4, 85)};
            \legend{Valore ottimo, Valore ammissibile, Valore effettivo}
        \end{axis}
    \end{tikzpicture}
