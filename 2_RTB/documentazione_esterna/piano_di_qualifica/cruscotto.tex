...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=blue, style={line width=1pt}, mark=none] coordinates {(Sprint 1, 1) (Sprint 2, 1) (Sprint 3, 0)};
            \legend{Valore ottimo, Valore ammissibile, Valore effettivo}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=opt, style={dashed, line width=3pt}, mark=none] coordinates {(Sprint 1, 100) (Sprint 2, 100) (Sprint 3, 100)};
            \addplot[color=amm, style={dashed, line width=3pt}, mark=none] coordinates {(Sprint 1, 90) (Sprint 2, 90) (Sprint 3, 90)};
            \addplot[color=blue, style={line width=1pt}, mark=none] coordinates {(Sprint 1, 43) (Sprint 2, 70) (Sprint 3, 80)};
            \legend{Valore ottimo, Valore ammissibile, Valore effettivo}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=amm, style={dashed, line width=3pt}, mark=none] coordinates {(Sprint 1, 3) (Sprint 2, 3) (Sprint 3, 3)};
            \addplot[color=blue, style={line width=1pt}, mark=none] coordinates {(Sprint 1, 2.5) (Sprint 2, 2) (Sprint 3, 4)};
            \legend{Valore ottimo, Valore ammissibile, Valore effettivo}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[color=blue, style={line width=1pt}, mark=none] coordinates {(Sprint 1, 0) (Sprint 2, 80) (Sprint 3, 90)};
            \legend{Valore ottimo, Valore ammissibile, Valore effettivo}
        \end{axis}
    \end{tikzpicture}
