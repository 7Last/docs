...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 1: rischio organizzativo \textit{RO3 - Pianificazione delle attivitià}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 2: rischio organizzativo \textit{RO2 - Impegni personali o universitari}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 3: rischio organizzativo \textit{RO3 - Ritardi rispetto ai costi previsti}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 4: rischio organizzativo \textit{RO2 - Scarsa collaborazione da parte di uno o più membri}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 5: rischio tecnologico \textit{RT3 - Inesperienza nell'uso delle tecnologie adottate}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 6: rischio tecnologico \textit{RT2 - Perdita di informazioni}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 7: rischio tecnologico \textit{RT3 - Problemi di compatibilità tra le tecnologie utilizzate}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 8: rischio comunicativo \textit{RC1 - Disaccordi all'interno del gruppo}}
\end{table}
...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{section}{Tabella 9: rischio comunicativo \textit{RC2 - Problemi di comunicazione}}
\end{table}
...
\subsection{Requirements and Technology Baseline}
    \subsubsection{Primo sprint:}
        ...
        \begin{table}[!h]
            ...
            \addcontentsline{tabelle}{section}{Tabella 10: preventivo orario per ruolo di ciascun membro del team durante il primo periodo}
        \end{table}
        ...
        \addcontentsline{immagini}{section}{Figura 1: impegno preventivo per ruolo di ciascun membro del team durante il primo periodo}
        \end{figure*}
        ...
        \addcontentsline{immagini}{section}{Figura 2: ripartizione in percentuale dei ruoli nel primo periodo}
        \end{figure*}
        ...
        \begin{table}[!h]
            ...
            \addcontentsline{tabelle}{section}{Tabella 11: impegno effettivo per ruolo di ciascun membro del team durante il primo periodo}
        \end{table}
        \newpage
        ...
        \begin{table}[!h]
            ...
            \addcontentsline{tabelle}{section}{Tabella 12: aggiornamenti economici del progetto al termine del primo periodo, riflettendo le variazioni tra preventivo e ore effettivamente lavorate}
        \end{table}
