...
\begin{table}[!h]
    ...
    \addcontentsline{tabelle}{subsection}{Tabella 10: Calendario di progetto}
...
\begin{table}[!h]
    ...
    \end{center}
    \caption{Calendario di progetto}
    \addcontentsline{tabelle}{subsection}{Tabella 11: Calendario di progetto}
...
\subsection{Requirements and Technology Baseline}
    \subsubsection{Primo sprint:}
        ...
        \begin{table}[!h]
            ...
            \addcontentsline{tabelle}{subsection}{Tabella 12: preventivo orario per ruolo di ciascun membro del team durante il primo periodo}
        \end{table}
...
%---------1_ISTOGRAMMA-----------%
        ...
        \addcontentsline{immagini}{subsection}{Figura1: impegno preventivo per ruolo di ciascun membro del team durante il primo periodo}
        \end{figure*}
