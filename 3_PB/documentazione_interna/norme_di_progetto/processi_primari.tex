...
\begin{enumerate}
	...
	\item \textbf{attributi} - elenco degli attributi della classe, con il relativo tipo di dato, seguendo il formato: 
		...
		\begin{itemize}
			...
			\item \textbf{Molteplicità} presente nel caso di una sequenza di elementi come liste o array, indica il numero di elementi presenti, se quest0 non fosse conosciut0 si utilizza il simbolo \textit{*} (es \textit{tipoAttributo[*]});
