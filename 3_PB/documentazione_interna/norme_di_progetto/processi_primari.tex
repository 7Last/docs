...
\begin{enumerate}
	...
	\item \textbf{importanza} - indica il grado di importanza del requisito, che può essere:
	      \begin{itemize}
		      \item \textbf{obbligatorio}, ovvero irrinunciabile per il \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#committente}{committente\textsubscript{G}};
	...
	\item \textbf{fonte} - indica la fonte da cui è stato identificato il requisito, che può essere:
	      \begin{itemize}
		      \item \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#capitolato}{\textbf{capitolato}\textsubscript{G}} indica i requisiti individuati a seguito dell'analisi dello stesso;
		      \item \textbf{interno} identifica i requisiti individuati durante le riunioni interne e da coloro che hanno il ruolo di \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#analista}{analista\textsubscript{G}};
		      \item \textbf{esterno} segnala i requisiti aggiuntivi individuati in seguito a incontri con la \href{https://7last.github.io/docs/rtb/documentazione-interna/glossario\#proponente}{proponente\textsubscript{G}};
