...
\subsubsubsection{Formato dei dati} % TODO
...
\end{lstlisting}
\captionof{lstlisting}{Configurazione del \textit{transformer} all'interno del file \texttt{clickhouse.json}}
...
\end{lstlisting}
\captionof{lstlisting}{Utilizzo del \textit{plugin} \texttt{avro-converter} all'interno del file \texttt{clickhouse.json}}
