...
\begin{enumerate}
	...
	\item assegnazione di un \textit{\textit{watermark}} ai dati, come precedentemente descritto nel paragrafo \hyperref[\textit{watermark}]{\underline{\textit{\textit{watermark}}}};
