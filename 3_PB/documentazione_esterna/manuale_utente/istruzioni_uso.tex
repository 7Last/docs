...
\begin{itemize}
    ...
    \item \textbf{Save dashboard}, consente di salvare le modifiche apportate.
        \begin{center}
            ...
            \captionof{figure}{Save dashboard}
        \end{center}
    \newpage
    \item \textbf{Dashboard settings}, permette una personalizzazione della \textit{dashboard} attuale.
        \begin{center}
            ...
            \captionof{figure}{Dashboard settings}
        \end{center}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Collegamento \textit{dashboard} sensori Raw Data}
        \end{center} 
    ...
    \begin{itemize}
        ...
        \begin{center}
            \includegraphics[width=0.7\textwidth]{manuale_utente/Rawdata/grafico_umidità_rawdata.png}
...
\begin{itemize}
    ...
    \begin{center}
        ...
        \captionof{figure}{Filtro \textit{dashboard} \textit{Environmental Data}}
    \end{center}
    \item riga \textit{\textbf{Temperature}} contenente:
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico temperatura giornaliera e settimanale \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico temperatura minima, massima e media \textit{dashboard} \textit{Environmental Data}}
        \end{center}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico mappa umidità \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico umidità settimanale \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico umidità minima, massima e media \textit{dashboard} \textit{Environmental Data}}
        \end{center}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico mappa sensori precipitazioni \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico precipitazioni orarie e giornaliere \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico precipitazioni mensili e annuali \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico precipitazione minima, massima e media \textit{dashboard} \textit{Environmental Data}}
        \end{center}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico mappa sensori livello fiumi \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico livello fiumi orari e giornalieri \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico livello fiumi mensili e annuali \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico livello fiume minimo, massimo e medio \textit{dashboard} \textit{Environmental Data}}
        \end{center}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Mappa qualità dell'aria \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Indice qualità aria e quantità agenti inquinanti \textit{dashboard} \textit{Environmental Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Inquinanti \textit{dashboard} \textit{Environmental Data}}
        \end{center}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{center}
        ...
        \captionof{figure}{Filtro \textit{dashboard} \textit{Urban Data}}
    \end{center}
    \item riga \textit{\textbf{Charging}} contenente:
    \begin{itemize}
        \item mappa dei sensori;
        \begin{center}
            ...
            \captionof{figure}{Mappa sensori colonnine di ricarica \textit{dashboard} \textit{Urban Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafici occupazione colonnine di ricarica \textit{dashboard} \textit{Urban Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafici efficienza colonnine di ricarica \textit{dashboard} \textit{Urban Data}}
        \end{center}
    ...
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Mappa sensori parcheggio \textit{dashboard} \textit{Urban Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico occupazione parcheggi \textit{dashboard} \textit{Urban Data}}
        \end{center}
    \end{itemize}
    \item riga \textit{\textbf{Traffic}} contenente:
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Mappa sensori traffico \textit{dashboard} \textit{Urban Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico velocità media e veicoli transitati \textit{dashboard} \textit{Urban Data}}
        \end{center}
    \end{itemize}
    \item riga \textit{\textbf{Recycling points}} contenente:
    \begin{itemize}
        ...
        \begin{center}
            ...
            \captionof{figure}{Mappa sensori isole ecologiche \textit{dashboard} \textit{Urban Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico storico svuotamenti isole ecologiche \textit{dashboard} \textit{Urban Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico totale saturazione ed efficienza isole ecologiche \textit{dashboard} \textit{Urban Data}}
        \end{center}
        ...
        \begin{center}
            ...
            \captionof{figure}{Grafico percentuale riempimento isole ecologiche \textit{dashboard} \textit{Urban Data}}
        \end{center}
    \end{itemize}
\end{itemize}
