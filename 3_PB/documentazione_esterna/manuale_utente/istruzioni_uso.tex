...
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/home.png}
...
\begin{center}
    \includegraphics[width=0.6\textwidth]{manuale_utente/barra_ricerca.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/barra_strumenti.png}
...
\begin{itemize}
    \item \textbf{Menù a tendina}, dove è possibile avere accesso ad alcune sezioni fondamentali per lo scopo ultimo di questo prodotto. Tra queste troviamo:
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=0.2\textwidth]{manuale_utente/menu_tendina.png}
    ...
    \item \textbf{Breadcrumb}, che mostra la posizione attuale dell'utente all'interno dell'applicazione.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{manuale_utente/breadcrumb.png}
            \captionof{figure}{Breadcrumb}
        \end{center}
    \item \textbf{Favorite mark}, che permette di aggiungere o rimuovere una dashboard dai preferiti.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{manuale_utente/favorite_mark.png}
    ...
    \item \textbf{Share dashboard}, che consente di condividere la dashboard corrente con altri utenti.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{manuale_utente/share.png}
    ...
    \item \textbf{Add button}, che permette di aggiungere un nuovo pannello alla dashboard corrente.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{manuale_utente/add_button.png}
    ...
    \item \textbf{Save dashboard}, che consente di salvare le modifiche apportate alla dashboard corrente.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{manuale_utente/save.png}
            \captionof{figure}{Salva dashboard}
        \end{center}
    \item \textbf{Impostazioni dashboard}, che permette di personalizzare la dashboard corrente.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{manuale_utente/settings.png}
    ...
    \item \textbf{Time range}, che consente di selezionare l'intervallo temporale dei dati visualizzati.
        \begin{center}
            \includegraphics[width=0.6\textwidth]{manuale_utente/time_range.png}
            \captionof{figure}{Time range}
        \end{center}
    \item \textbf{Refresh}, che permette di aggiornare i dati visualizzati.
        \begin{center}
            \includegraphics[width=0.1\textwidth]{manuale_utente/refresh.png}
...
% \end{itemize}
% \begin{center}
%     \includegraphics[width=0.3\textwidth]{manuale_utente/menu_tendina.png}
%     \captionof{figure}{Menù a tendina}
% \end{center}
\newpage
...
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/mappa.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/time_series.png}
...
\begin{center}
    \includegraphics[width=0.4\textwidth]{manuale_utente/stat.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/grafico_quadrante.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/grafico_barre.png}
...
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/tabelle.png}
...
\end{itemize}
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/general_dashboard.png}
...
\end{itemize}
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/eco_ice.png}
...
\end{itemize}
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/temperature.png}
...
\end{itemize}
\begin{center}
    \includegraphics[width=\textwidth]{manuale_utente/traffic.png}
...
\begin{center}
    \includegraphics[width=0.6\textwidth]{manuale_utente/alert_grafana.png}
...
\begin{center}
    \includegraphics[width=0.6\textwidth]{manuale_utente/notification.png}
