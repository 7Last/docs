...
\begin{itemize}
    ...
    \item \textbf{continuous integration}: rilasciando regolarmente delle integrazioni e sottoponendole immediatamente a test, è stato possibile ridurre i tempi di sviluppo e inviduare tempestivamente gli errori, garantendo un flusso di sviluppo fluido ed efficace.
\end{itemize}
