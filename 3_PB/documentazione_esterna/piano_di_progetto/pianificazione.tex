...
\newpage
\subsubsubsection{Consuntivo}
A causa degli esami universitari e di altri impegni personali, il gruppo non è riuscito ad ultimare tutte le attività pianificate per questo periodo. Queste verranno portate a termine con priorità massima nel prossimo sprint.
...
\subsubsubsection{Pianificazione}
Per questo periodo ci impegniamo a completare i test di integrazione iniziati il precedente sprint e a ultimare le finiture alle \textit{dashboard} in vista del collaudo finale. Verrà aggiornato il documento \textit{Norme di Progetto} con l'aggiunta degli ultimi test implementati, oltre al consueto aggiornamento dei documenti \textit{Piano di Progetto} e \textit{Piano di Qualifica} e alla stesura dei verbali.
...
\end{figure}
% \subsubsubsection{Consuntivo}
% Come preventivato, questo sprint ha richiesto un maggiore impegno per i verificatori, in quanto hanno dovuto effettuare la verifica finale di tutta la documentazione necessaria ad affrontare la revisione PB. Le ore preventivate si sono rivelate adeguate per le attività da svolgere, siamo quindi riusciti a rimanere entro il budget previsto per questo periodo.
...
% \subsubsubsubsection{Rischi effettivamente occorsi e loro mitigazione}
% Per questo sprint non si sono verificati rischi, né tra quelli preventivati né tra quelli non preventivati. Il gruppo ha lavorato in modo collaborativo e senza disaccordi, riuscendo a completare tutte le attività previste in tempo per la revisione PB.

% \subsubsubsection{Retrospettiva}
% Il collaudo finale con il proponente è stato superato con successo. Abbiamo ricevuto un feedback molto positivo e alcune indicazioni per migliorare la presentazione del prodotto. Abbiamo inoltre completato la verifica finale di tutta la documentazione e richiesto la revisione PB.
