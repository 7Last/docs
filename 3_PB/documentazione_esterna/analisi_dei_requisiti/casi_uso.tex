...
\begin{itemize}
	...
	\item \textbf{Postcondizioni}: l'autorità locale visualizza una tabella contenente i dati grezzi trasmessi dai sensori di livello dei fiumi.
	      Ciascuna riga contiene il nome del sensore, il valore in mm del livello dei fiumi e il timestamp della trasmissione.
	\item \textbf{Scenario principale}:
	      \begin{enumerate}
		      \item l'autorità locale accede alla piattaforma;
		      \item il sistema carica i dati trasmessi dai sensori interrogando il database;
...
\begin{center}
	...
	\captionof{figure}{UC-2.19: Visualizzazione grafico time series dati grezzi complessivi livello dei fiumi}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.70\textwidth]{analisi_dei_requisiti/UC-3.1.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.62\textwidth]{analisi_dei_requisiti/UC-3.1.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.65\textwidth]{analisi_dei_requisiti/UC-3.1.3.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.65\textwidth]{analisi_dei_requisiti/UC-3.1.4.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.65\textwidth]{analisi_dei_requisiti/UC-3.1.5.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.65\textwidth]{analisi_dei_requisiti/UC-3.1.6.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.65\textwidth]{analisi_dei_requisiti/UC-3.2.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.2.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.65\textwidth]{analisi_dei_requisiti/UC-3.2.3.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.65\textwidth]{analisi_dei_requisiti/UC-3.2.4.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.2.5.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.2.6.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.3.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.3.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.3.3.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.3.4.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.3.5.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.3.6.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.4.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.4.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.4.3.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.4.4.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.4.5.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.4.6.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.5.1.png}
	\captionof{figure}{UC-3.5.1, Visualizzazione grafico time series livello dei fiumi}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-3.5.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-3.5.3.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-3.5.4.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.1.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.1.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.1.3.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.1.4.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.2.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.2.2.png}
	\captionof{figure}{UC-4.2.2: Visualizzazione \href{https://7last.github.io/docs/pb/documentazione-interna/glossario\#panel}{\textit{panel}\textsubscript{G}} numero colonnine di ricarica per stato}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-4.3.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-4.3.2.png}
	\captionof{figure}{UC-4.3.2: Visualizzazione \href{https://7last.github.io/docs/pb/documentazione-interna/glossario\#panel}{\textit{panel}\textsubscript{G}} parcheggi con rispettivo stato di occupazione in tempo reale}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.4.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.4.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.4.3.png}
	\captionof{figure}{UC-4.4.3: Visualizzazione grafico time series isole ecologiche}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.6\textwidth]{analisi_dei_requisiti/UC-4.4.4.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-4.4.5.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-4.4.6.png}
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	      \begin{enumerate}
		      \item il sensore effettua una misurazione del livello dei fiumi;
		      \item il sensore formatta i dati da inviare al sistema, includendo il livello dei fiumi in cm, l'identificativo del sensore,
		            il timestamp, e la sua posizione geografica;
		      \item il sensore invia i dati al sistema.
	      \end{enumerate}
	\item \href{https://7last.github.io/docs/pb/documentazione-interna/glossario\#user-story}{\textbf{User story}\textsubscript{G}}: come sensore, desidero poter inviare al sistema le rilevazioni sul livello dei fiumi.
\end{itemize}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-16.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-16.1.png}
	\captionof{figure}{UC-16.1: Applicazione filtro per tipo di sensore}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-16.2.png}
	\captionof{figure}{UC-16.2: Applicazione filtro per nome del sensore}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-16.3.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-17.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-17.1.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-17.2.png}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-17.3.png}
	\captionof{figure}{UC-17.3: Visualizzazione notifica superamento indice 3 EAQI}
\end{center}
...
\end{itemize}
\begin{center}
	\includegraphics[width=0.75\textwidth]{analisi_dei_requisiti/UC-17.4.png}
