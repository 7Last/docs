...
\begin{center}
	...
	\captionof{figure}{UC-4.1.5: Visualizzazione \href{https://7last.github.io/docs/pb/documentazione-interna/glossario\#panel}{\textit{panel}\textsubscript{G}} calcolo ora di punta}
\end{center}
...
\subsubsection{UC-6.1: Trasmissione dati temperatura}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.1: Trasmissione dati temperatura}
\end{center}

\subsubsection{UC-6.2: Trasmissione dati umidità}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.2: Trasmissione dati umidità}
\end{center}

\subsubsection{UC-6.3: Trasmissione dati qualità dell'aria}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.3: Trasmissione dati qualità dell'aria}
\end{center}

\subsubsection{UC-6.4: Trasmissione dati precipitazioni}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.4: Trasmissione dati precipitazioni}
\end{center}
\subsubsection{UC-6.5: Trasmissione dati traffico}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.5: Trasmissione dati traffico}
\end{center}

\subsubsection{UC-6.6: Trasmissione dati colonnine di ricarica}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.6: Trasmissione dati colonnine di ricarica}
\end{center}

\subsubsection{UC-6.7: Trasmissione dati parcheggi}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.7: Trasmissione dati parcheggi}
\end{center}

\subsubsection{UC-6.8: Trasmissione dati isole ecologiche}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.8: Trasmissione dati isole ecologiche}
\end{center}

\subsubsection{UC-6.9: Trasmissione dati livello di acqua}
\begin{itemize}
	\item \textbf{Attore principale}: sensore.
	\item \textbf{Precondizioni}: il sensore è attivo e collegato al sistema.
	\item \textbf{Postcondizioni}: i dati inviati dal sensore sono stati elaborati e memorizzati nel sistema.
...
\begin{center}
	...
	\captionof{figure}{UC-6.9: Trasmissione dati livello di acqua}
\end{center}

\subsubsection{UC-7: Applicazione filtro}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\subsubsection{UC-7.1: Applicazione filtro per tipo di sensore}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\begin{center}
	...
	\captionof{figure}{UC-7.1: Applicazione filtro per tipo di sensore}
\end{center}

\subsubsection{UC-7.2: Applicazione filtro per nome del sensore}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\begin{center}
	...
	\captionof{figure}{UC-7.2: Applicazione filtro per nome del sensore}
\end{center}

\subsubsection{UC-7.3: Applicazione filtro temporale}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}:
	      \begin{enumerate}
...
\begin{center}
	...
	\captionof{figure}{UC-7.3: Applicazione filtro temporale}
\end{center}

\subsubsection{UC-8: Visualizzazione notifica superamento soglie}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
...
\subsubsection{UC-8.1: Visualizzazione notifica superamento soglia di temperatura}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}: nessuna
...
\begin{center}
	...
	\captionof{figure}{UC-8.1: Visualizzazione notifica superamento soglie di temperatura}
\end{center}

\subsubsection{UC-8.2: Visualizzazione notifica superamento soglia di riempimento dell'isola ecologica}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}: nessuna.
...
\begin{center}
	...
	\captionof{figure}{UC-8.2: Visualizzazione notifica superamento soglia di riempimento dell'isola ecologica}
\end{center}

\subsubsection{UC-8.3: Visualizzazione notifica superamento indice 3 EAQI}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}: nessuna.
...
\begin{center}
	...
	\captionof{figure}{UC-8.3: Visualizzazione notifica superamento indice 3 EAQI}
\end{center}

\subsubsection{UC-8.4: Visualizzazione notifica superamento livello di precipitazioni}
\begin{itemize}
	\item \textbf{Attore principale}: autorità locale.
	\item \textbf{Precondizioni}: nessuna.
...
\begin{center}
	...
	\captionof{figure}{UC-8.4: Visualizzazione notifica superamento livello di precipitazioni}
\end{center}